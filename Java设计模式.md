...
**BeanDefinitionReader用来解析bean定义，并封装成BeanDefinition对象**，而我们定义的配置文件中定义了很多bean标签，所以就有一个问题，解析的**BeanDefinition**对象**存储到**哪儿？答案就是BeanDefinition的注册中心，而该注册中心顶层接口就是**BeanDefinitionRegistry**。
